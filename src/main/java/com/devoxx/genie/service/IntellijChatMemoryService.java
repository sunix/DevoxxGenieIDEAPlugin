...
public class IntellijChatMemoryService implements ChatMemorySizeListener, ChatMemoryService {
     ...
     */
    @NotNull
    public static IntellijChatMemoryService getInstance() {
        return ApplicationManager.getApplication().getService(IntellijChatMemoryService.class);
    }
