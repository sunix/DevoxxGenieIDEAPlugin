...
public class CliChatMemoryService implements ChatMemoryService {

    private static final CliChatMemoryService INSTANCE = new CliChatMemoryService();

    public static CliChatMemoryService getInstance() {
        return INSTANCE;
    }
